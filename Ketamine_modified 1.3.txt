...
local objects = {
    ...
    -- Custom: Hide button (in topbar, next to Close)
    ["InstanceHideBtn"] = Instance.new("TextButton"); -- Hide
    ["InstanceHideBtnARC"] = Instance.new("UIAspectRatioConstraint");
    ["InstanceHideBtnIcon"] = Instance.new("ImageLabel"); -- Icon

    -- Custom: Floating open button (draggable, shown when GUI is hidden)
    ["InstanceOpenBtn"] = Instance.new("TextButton"); -- OpenBtn
    ["InstanceOpenBtnCorner"] = Instance.new("UICorner");
    ["InstanceOpenBtnLabel"] = Instance.new("TextLabel");

    -- Custom: Toast notification system
    ["InstanceToastHolder"] = Instance.new("Frame"); -- ToastHolder
    ["InstanceToast"] = Instance.new("Frame"); -- Toast template
    ["InstanceToastCorner"] = Instance.new("UICorner");
    ["InstanceToastStroke"] = Instance.new("UIStroke");
    ["InstanceToastBar"] = Instance.new("Frame"); -- color bar
    ["InstanceToastText"] = Instance.new("TextLabel"); -- toast text
    ["InstanceToastListLayout"] = Instance.new("UIListLayout");

    -- Custom: Badges for RSpy/ESpy/HTTPSpy sidebar buttons
    ["InstanceBadgeRSpy"] = Instance.new("Frame");
    ["InstanceBadgeRSpyCorner"] = Instance.new("UICorner");
    ["InstanceBadgeRSpyLabel"] = Instance.new("TextLabel");

    ["InstanceBadgeESpy"] = Instance.new("Frame");
    ["InstanceBadgeESpyCorner"] = Instance.new("UICorner");
    ["InstanceBadgeESpyLabel"] = Instance.new("TextLabel");

    ["InstanceBadgeHTTP"] = Instance.new("Frame");
    ["InstanceBadgeHTTPCorner"] = Instance.new("UICorner");
    ["InstanceBadgeHTTPLabel"] = Instance.new("TextLabel");

    -- Custom: Resize handle (bottom-right corner)
    ["InstanceResizeHandle"] = Instance.new("TextButton");
    ["InstanceResizeIcon"] = Instance.new("ImageLabel");

    -- Custom: Hotkey label on OpenBtn
    ["InstanceHotkeyHint"] = Instance.new("TextLabel");

    -- Custom: Clipboard history frame (overlay inside main)
    ["InstanceClipFrame"] = Instance.new("Frame");
    ["InstanceClipCorner"] = Instance.new("UICorner");
    ["InstanceClipStroke"] = Instance.new("UIStroke");
    ["InstanceClipTitle"] = Instance.new("TextLabel");
    ["InstanceClipScroll"] = Instance.new("ScrollingFrame");
    ["InstanceClipList"] = Instance.new("UIListLayout");
    ["InstanceClipSep"] = Instance.new("Frame");
    ["InstanceClipClose"] = Instance.new("TextButton");
    ["InstanceClipCloseIcon"] = Instance.new("ImageLabel");
    ["InstanceClipCloseARC"] = Instance.new("UIAspectRatioConstraint");
    ["InstanceClipEmpty"] = Instance.new("TextLabel");

    -- Custom: Bookmark frame (overlay inside main)
    ["InstanceBMFrame"] = Instance.new("Frame");
    ["InstanceBMCorner"] = Instance.new("UICorner");
    ["InstanceBMStroke"] = Instance.new("UIStroke");
    ["InstanceBMTitle"] = Instance.new("TextLabel");
    ["InstanceBMScroll"] = Instance.new("ScrollingFrame");
    ["InstanceBMList"] = Instance.new("UIListLayout");
    ["InstanceBMSep"] = Instance.new("Frame");
    ["InstanceBMClose"] = Instance.new("TextButton");
    ["InstanceBMCloseIcon"] = Instance.new("ImageLabel");
    ["InstanceBMCloseARC"] = Instance.new("UIAspectRatioConstraint");
    ["InstanceBMEmpty"] = Instance.new("TextLabel");
    ["InstanceBMAddBtn"] = Instance.new("TextButton");
    ["InstanceBMAddCorner"] = Instance.new("UICorner");
    ["InstanceBMAddLabel"] = Instance.new("TextLabel");

    -- Custom: Topbar bookmark/clipboard toggle buttons
    ["InstanceBtnClip"] = Instance.new("TextButton");
    ["InstanceBtnClipARC"] = Instance.new("UIAspectRatioConstraint");
    ["InstanceBtnClipIcon"] = Instance.new("ImageLabel");
    ["InstanceBtnBM"] = Instance.new("TextButton");
    ["InstanceBtnBMARC"] = Instance.new("UIAspectRatioConstraint");
    ["InstanceBtnBMIcon"] = Instance.new("ImageLabel");

    -- Custom: Theme toggle button (topbar)
    ["InstanceBtnTheme"] = Instance.new("TextButton");
    ["InstanceBtnThemeARC"] = Instance.new("UIAspectRatioConstraint");
    ["InstanceBtnThemeIcon"] = Instance.new("ImageLabel");
};
...
do -- Set properties
    ...
    objects["Instance0"]["Name"] = "Modified By JABA";
    ...
    objects["Instance24"]["Text"] = "Modified By JABA";
    ...
    -- Hide button (next to Close, in Buttons frame of TopbarZone)
    objects["InstanceHideBtn"]["Name"] = "Hide";
    objects["InstanceHideBtn"]["Parent"] = objects["Instance26"]; -- Buttons frame
    objects["InstanceHideBtn"]["AnchorPoint"] = Vector2.new(0, 0);
    objects["InstanceHideBtn"]["Position"] = UDim2.new(0, 0, 0, 0);
    objects["InstanceHideBtn"]["Size"] = UDim2.new(1, 0, 1, 0);
    objects["InstanceHideBtn"]["BackgroundTransparency"] = 1;
    objects["InstanceHideBtn"]["BorderSizePixel"] = 0;
    objects["InstanceHideBtn"]["Text"] = "";
    objects["InstanceHideBtn"]["AutoButtonColor"] = false;
    objects["InstanceHideBtn"]["Active"] = true;
    objects["InstanceHideBtn"]["Selectable"] = true;
    objects["InstanceHideBtn"]["ZIndex"] = 2;
    objects["InstanceHideBtn"]["LayoutOrder"] = 2; -- after Minimize(0) and Close(1)

    objects["InstanceHideBtnARC"]["AspectRatio"] = 1;
    objects["InstanceHideBtnARC"]["Name"] = "UIAspectRatioConstraint";
    objects["InstanceHideBtnARC"]["Parent"] = objects["InstanceHideBtn"];
    objects["InstanceHideBtnARC"]["AspectType"] = Enum.AspectType.FitWithinMaxSize;
    objects["InstanceHideBtnARC"]["DominantAxis"] = Enum.DominantAxis.Width;

    objects["InstanceHideBtnIcon"]["Name"] = "Icon";
    objects["InstanceHideBtnIcon"]["Parent"] = objects["InstanceHideBtn"];
    objects["InstanceHideBtnIcon"]["Size"] = UDim2.new(0.5, 0, 0.5, 0);
    objects["InstanceHideBtnIcon"]["Position"] = UDim2.new(0.5, 0, 0.5, 0);
    objects["InstanceHideBtnIcon"]["AnchorPoint"] = Vector2.new(0.5, 0.5);
    objects["InstanceHideBtnIcon"]["BackgroundTransparency"] = 1;
    objects["InstanceHideBtnIcon"]["Image"] = "rbxassetid://3926305904"; -- eye/hide icon
    objects["InstanceHideBtnIcon"]["ImageColor3"] = Color3.new(1, 1, 1);
    objects["InstanceHideBtnIcon"]["ScaleType"] = Enum.ScaleType.Stretch;
    objects["InstanceHideBtnIcon"]["BorderSizePixel"] = 0;
    objects["InstanceHideBtnIcon"]["ZIndex"] = 2;

    -- Floating open button (shown when GUI is minimized, draggable)
    objects["InstanceOpenBtn"]["Name"] = "OpenBtn";
    objects["InstanceOpenBtn"]["Parent"] = objects["Instance0"]; -- ScreenGui
    objects["InstanceOpenBtn"]["AnchorPoint"] = Vector2.new(0.5, 0.5);
    objects["InstanceOpenBtn"]["Position"] = UDim2.new(0.05, 0, 0.5, 0);
    objects["InstanceOpenBtn"]["Size"] = UDim2.new(0, 54, 0, 54);
    objects["InstanceOpenBtn"]["BackgroundColor3"] = Color3.new(0, 0, 0);
    objects["InstanceOpenBtn"]["BackgroundTransparency"] = 0;
    objects["InstanceOpenBtn"]["BorderSizePixel"] = 0;
    objects["InstanceOpenBtn"]["Text"] = "";
    objects["InstanceOpenBtn"]["AutoButtonColor"] = false;
    objects["InstanceOpenBtn"]["Active"] = true;
    objects["InstanceOpenBtn"]["Selectable"] = true;
    objects["InstanceOpenBtn"]["ZIndex"] = 10;
    objects["InstanceOpenBtn"]["Visible"] = false; -- hidden by default (shown when GUI minimized)

    objects["InstanceOpenBtnCorner"]["CornerRadius"] = UDim.new(0, 12); -- квадрат с округлёнными углами
    objects["InstanceOpenBtnCorner"]["Name"] = "UICorner";
    objects["InstanceOpenBtnCorner"]["Parent"] = objects["InstanceOpenBtn"];

    objects["InstanceOpenBtnLabel"]["Name"] = "Label";
    objects["InstanceOpenBtnLabel"]["Parent"] = objects["InstanceOpenBtn"];
    objects["InstanceOpenBtnLabel"]["Size"] = UDim2.new(1, 0, 0.7, 0);
    objects["InstanceOpenBtnLabel"]["Position"] = UDim2.new(0, 0, 0.1, 0);
    objects["InstanceOpenBtnLabel"]["BackgroundTransparency"] = 1;
    objects["InstanceOpenBtnLabel"]["Text"] = "K";
    objects["InstanceOpenBtnLabel"]["TextColor3"] = Color3.new(1, 1, 1);
    objects["InstanceOpenBtnLabel"]["TextScaled"] = true;
    objects["InstanceOpenBtnLabel"]["FontFace"] = Font.new("rbxasset://fonts/families/TitilliumWeb.json", Enum.FontWeight.Bold, Enum.FontStyle.Normal, true);
    objects["InstanceOpenBtnLabel"]["ZIndex"] = 11;
    objects["InstanceOpenBtnLabel"]["BorderSizePixel"] = 0;

    -- Hotkey hint under the open button
    objects["InstanceHotkeyHint"]["Name"] = "HotkeyHint";
    objects["InstanceHotkeyHint"]["Parent"] = objects["InstanceOpenBtn"];
    objects["InstanceHotkeyHint"]["Size"] = UDim2.new(1, 0, 0.28, 0);
    objects["InstanceHotkeyHint"]["Position"] = UDim2.new(0, 0, 0.72, 0);
    objects["InstanceHotkeyHint"]["BackgroundTransparency"] = 1;
    objects["InstanceHotkeyHint"]["Text"] = "RShift";
    objects["InstanceHotkeyHint"]["TextColor3"] = Color3.new(0.7, 0.7, 0.7);
    objects["InstanceHotkeyHint"]["TextScaled"] = true;
    objects["InstanceHotkeyHint"]["FontFace"] = Font.new("rbxasset://fonts/families/TitilliumWeb.json", Enum.FontWeight.Regular, Enum.FontStyle.Normal, false);
    objects["InstanceHotkeyHint"]["ZIndex"] = 11;
    objects["InstanceHotkeyHint"]["BorderSizePixel"] = 0;

    -- =====================================================
    -- TOAST NOTIFICATION HOLDER (top-right of screen)
    -- =====================================================
    objects["InstanceToastHolder"]["Name"] = "ToastHolder";
    objects["InstanceToastHolder"]["Parent"] = objects["Instance0"];
    objects["InstanceToastHolder"]["AnchorPoint"] = Vector2.new(1, 0);
    objects["InstanceToastHolder"]["Position"] = UDim2.new(1, -12, 0, 12);
    objects["InstanceToastHolder"]["Size"] = UDim2.new(0, 260, 1, -24);
    objects["InstanceToastHolder"]["BackgroundTransparency"] = 1;
    objects["InstanceToastHolder"]["ZIndex"] = 100;
    objects["InstanceToastHolder"]["BorderSizePixel"] = 0;

    objects["InstanceToastListLayout"]["Parent"] = objects["InstanceToastHolder"];
    objects["InstanceToastListLayout"]["FillDirection"] = Enum.FillDirection.Vertical;
    objects["InstanceToastListLayout"]["HorizontalAlignment"] = Enum.HorizontalAlignment.Right;
    objects["InstanceToastListLayout"]["VerticalAlignment"] = Enum.VerticalAlignment.Top;
    objects["InstanceToastListLayout"]["SortOrder"] = Enum.SortOrder.LayoutOrder;
    objects["InstanceToastListLayout"]["Padding"] = UDim.new(0, 6);
    objects["InstanceToastListLayout"]["Name"] = "UIListLayout";

    -- Toast template (will be cloned at runtime)
    objects["InstanceToast"]["Name"] = "ToastTemplate";
    objects["InstanceToast"]["Parent"] = objects["InstanceToastHolder"];
    objects["InstanceToast"]["Size"] = UDim2.new(1, 0, 0, 44);
    objects["InstanceToast"]["BackgroundColor3"] = Color3.new(0.105882, 0.105882, 0.105882);
    objects["InstanceToast"]["BackgroundTransparency"] = 0.1;
    objects["InstanceToast"]["BorderSizePixel"] = 0;
    objects["InstanceToast"]["ZIndex"] = 100;
    objects["InstanceToast"]["Visible"] = false;
    objects["InstanceToast"]["ClipsDescendants"] = true;

    objects["InstanceToastCorner"]["CornerRadius"] = UDim.new(0, 8);
    objects["InstanceToastCorner"]["Parent"] = objects["InstanceToast"];

    objects["InstanceToastStroke"]["Parent"] = objects["InstanceToast"];
    objects["InstanceToastStroke"]["Color"] = Color3.new(0.294118, 0.294118, 0.294118);
    objects["InstanceToastStroke"]["Thickness"] = 1;
    objects["InstanceToastStroke"]["Transparency"] = 0.5;

    objects["InstanceToastBar"]["Name"] = "Bar";
    objects["InstanceToastBar"]["Parent"] = objects["InstanceToast"];
    objects["InstanceToastBar"]["Size"] = UDim2.new(0, 4, 1, 0);
    objects["InstanceToastBar"]["Position"] = UDim2.new(0, 0, 0, 0);
    objects["InstanceToastBar"]["BackgroundColor3"] = Color3.new(0.5, 0.8, 0.5);
    objects["InstanceToastBar"]["BorderSizePixel"] = 0;
    objects["InstanceToastBar"]["ZIndex"] = 101;

    objects["InstanceToastText"]["Name"] = "Label";
    objects["InstanceToastText"]["Parent"] = objects["InstanceToast"];
    objects["InstanceToastText"]["Size"] = UDim2.new(1, -18, 1, 0);
    objects["InstanceToastText"]["Position"] = UDim2.new(0, 14, 0, 0);
    objects["InstanceToastText"]["BackgroundTransparency"] = 1;
    objects["InstanceToastText"]["TextColor3"] = Color3.new(1, 1, 1);
    objects["InstanceToastText"]["TextScaled"] = true;
    objects["InstanceToastText"]["TextXAlignment"] = Enum.TextXAlignment.Left;
    objects["InstanceToastText"]["FontFace"] = Font.new("rbxasset://fonts/families/Nunito.json", Enum.FontWeight.Bold, Enum.FontStyle.Normal, true);
    objects["InstanceToastText"]["Text"] = "Notification";
    objects["InstanceToastText"]["ZIndex"] = 101;
    objects["InstanceToastText"]["BorderSizePixel"] = 0;

    -- =====================================================
    -- BADGES for RSpy / ESpy / HTTPSpy sidebar buttons
    -- =====================================================
    -- RSpy badge
    objects["InstanceBadgeRSpy"]["Name"] = "Badge";
    objects["InstanceBadgeRSpy"]["Parent"] = objects["Instance54"]; -- RSpy button
    objects["InstanceBadgeRSpy"]["AnchorPoint"] = Vector2.new(1, 0.5);
    objects["InstanceBadgeRSpy"]["Position"] = UDim2.new(0.98, 0, 0.18, 0);
    objects["InstanceBadgeRSpy"]["Size"] = UDim2.new(0, 16, 0, 16);
    objects["InstanceBadgeRSpy"]["BackgroundColor3"] = Color3.new(0.85, 0.3, 0.3);
    objects["InstanceBadgeRSpy"]["BorderSizePixel"] = 0;
    objects["InstanceBadgeRSpy"]["ZIndex"] = 5;
    objects["InstanceBadgeRSpy"]["Visible"] = false;

    objects["InstanceBadgeRSpyCorner"]["CornerRadius"] = UDim.new(1, 0);
    objects["InstanceBadgeRSpyCorner"]["Parent"] = objects["InstanceBadgeRSpy"];

    objects["InstanceBadgeRSpyLabel"]["Name"] = "Label";
    objects["InstanceBadgeRSpyLabel"]["Parent"] = objects["InstanceBadgeRSpy"];
    objects["InstanceBadgeRSpyLabel"]["Size"] = UDim2.new(1, 0, 1, 0);
    objects["InstanceBadgeRSpyLabel"]["BackgroundTransparency"] = 1;
    objects["InstanceBadgeRSpyLabel"]["TextColor3"] = Color3.new(1, 1, 1);
    objects["InstanceBadgeRSpyLabel"]["TextScaled"] = true;
    objects["InstanceBadgeRSpyLabel"]["FontFace"] = Font.new("rbxasset://fonts/families/Nunito.json", Enum.FontWeight.Bold, Enum.FontStyle.Normal, true);
    objects["InstanceBadgeRSpyLabel"]["Text"] = "0";
    objects["InstanceBadgeRSpyLabel"]["ZIndex"] = 6;
    objects["InstanceBadgeRSpyLabel"]["BorderSizePixel"] = 0;

    -- ESpy badge
    objects["InstanceBadgeESpy"]["Name"] = "Badge";
    objects["InstanceBadgeESpy"]["Parent"] = objects["Instance69"]; -- ESpy button
    objects["InstanceBadgeESpy"]["AnchorPoint"] = Vector2.new(1, 0.5);
    objects["InstanceBadgeESpy"]["Position"] = UDim2.new(0.98, 0, 0.18, 0);
    objects["InstanceBadgeESpy"]["Size"] = UDim2.new(0, 16, 0, 16);
    objects["InstanceBadgeESpy"]["BackgroundColor3"] = Color3.new(0.3, 0.6, 0.85);
    objects["InstanceBadgeESpy"]["BorderSizePixel"] = 0;
    objects["InstanceBadgeESpy"]["ZIndex"] = 5;
    objects["InstanceBadgeESpy"]["Visible"] = false;

    objects["InstanceBadgeESpyCorner"]["CornerRadius"] = UDim.new(1, 0);
    objects["InstanceBadgeESpyCorner"]["Parent"] = objects["InstanceBadgeESpy"];

    objects["InstanceBadgeESpyLabel"]["Name"] = "Label";
    objects["InstanceBadgeESpyLabel"]["Parent"] = objects["InstanceBadgeESpy"];
    objects["InstanceBadgeESpyLabel"]["Size"] = UDim2.new(1, 0, 1, 0);
    objects["InstanceBadgeESpyLabel"]["BackgroundTransparency"] = 1;
    objects["InstanceBadgeESpyLabel"]["TextColor3"] = Color3.new(1, 1, 1);
    objects["InstanceBadgeESpyLabel"]["TextScaled"] = true;
    objects["InstanceBadgeESpyLabel"]["FontFace"] = Font.new("rbxasset://fonts/families/Nunito.json", Enum.FontWeight.Bold, Enum.FontStyle.Normal, true);
    objects["InstanceBadgeESpyLabel"]["Text"] = "0";
    objects["InstanceBadgeESpyLabel"]["ZIndex"] = 6;
    objects["InstanceBadgeESpyLabel"]["BorderSizePixel"] = 0;

    -- HTTPSpy badge
    objects["InstanceBadgeHTTP"]["Name"] = "Badge";
    objects["InstanceBadgeHTTP"]["Parent"] = objects["Instance64"]; -- HTTPSpy button
    objects["InstanceBadgeHTTP"]["AnchorPoint"] = Vector2.new(1, 0.5);
    objects["InstanceBadgeHTTP"]["Position"] = UDim2.new(0.98, 0, 0.18, 0);
    objects["InstanceBadgeHTTP"]["Size"] = UDim2.new(0, 16, 0, 16);
    objects["InstanceBadgeHTTP"]["BackgroundColor3"] = Color3.new(0.85, 0.6, 0.2);
    objects["InstanceBadgeHTTP"]["BorderSizePixel"] = 0;
    objects["InstanceBadgeHTTP"]["ZIndex"] = 5;
    objects["InstanceBadgeHTTP"]["Visible"] = false;

    objects["InstanceBadgeHTTPCorner"]["CornerRadius"] = UDim.new(1, 0);
    objects["InstanceBadgeHTTPCorner"]["Parent"] = objects["InstanceBadgeHTTP"];

    objects["InstanceBadgeHTTPLabel"]["Name"] = "Label";
    objects["InstanceBadgeHTTPLabel"]["Parent"] = objects["InstanceBadgeHTTP"];
    objects["InstanceBadgeHTTPLabel"]["Size"] = UDim2.new(1, 0, 1, 0);
    objects["InstanceBadgeHTTPLabel"]["BackgroundTransparency"] = 1;
    objects["InstanceBadgeHTTPLabel"]["TextColor3"] = Color3.new(1, 1, 1);
    objects["InstanceBadgeHTTPLabel"]["TextScaled"] = true;
    objects["InstanceBadgeHTTPLabel"]["FontFace"] = Font.new("rbxasset://fonts/families/Nunito.json", Enum.FontWeight.Bold, Enum.FontStyle.Normal, true);
    objects["InstanceBadgeHTTPLabel"]["Text"] = "0";
    objects["InstanceBadgeHTTPLabel"]["ZIndex"] = 6;
    objects["InstanceBadgeHTTPLabel"]["BorderSizePixel"] = 0;

    -- =====================================================
    -- RESIZE HANDLE (bottom-right corner of Window)
    -- =====================================================
    objects["InstanceResizeHandle"]["Name"] = "ResizeHandle";
    objects["InstanceResizeHandle"]["Parent"] = objects["Instance1"]; -- Window
    objects["InstanceResizeHandle"]["AnchorPoint"] = Vector2.new(1, 1);
    objects["InstanceResizeHandle"]["Position"] = UDim2.new(1, 0, 1, 0);
    objects["InstanceResizeHandle"]["Size"] = UDim2.new(0, 22, 0, 22);
    objects["InstanceResizeHandle"]["BackgroundTransparency"] = 1;
    objects["InstanceResizeHandle"]["BorderSizePixel"] = 0;
    objects["InstanceResizeHandle"]["Text"] = "";
    objects["InstanceResizeHandle"]["AutoButtonColor"] = false;
    objects["InstanceResizeHandle"]["Active"] = true;
    objects["InstanceResizeHandle"]["ZIndex"] = 10;

    objects["InstanceResizeIcon"]["Name"] = "Icon";
    objects["InstanceResizeIcon"]["Parent"] = objects["InstanceResizeHandle"];
    objects["InstanceResizeIcon"]["Size"] = UDim2.new(0.75, 0, 0.75, 0);
    objects["InstanceResizeIcon"]["Position"] = UDim2.new(0.5, 0, 0.5, 0);
    objects["InstanceResizeIcon"]["AnchorPoint"] = Vector2.new(0.5, 0.5);
    objects["InstanceResizeIcon"]["BackgroundTransparency"] = 1;
    objects["InstanceResizeIcon"]["Image"] = "rbxassetid://7072718362";
    objects["InstanceResizeIcon"]["ImageColor3"] = Color3.new(0.5, 0.5, 0.5);
    objects["InstanceResizeIcon"]["ZIndex"] = 10;
    objects["InstanceResizeIcon"]["BorderSizePixel"] = 0;

    -- =====================================================
    -- TOPBAR EXTRA BUTTONS (clipboard, bookmarks, theme)
    -- =====================================================
    -- Clip button
    objects["InstanceBtnClip"]["Name"] = "ClipBtn";
    objects["InstanceBtnClip"]["Parent"] = objects["Instance20"]; -- TopbarZone
    objects["InstanceBtnClip"]["AnchorPoint"] = Vector2.new(1, 0.5);
    objects["InstanceBtnClip"]["Position"] = UDim2.new(0.72, 0, 0.5, 0);
    objects["InstanceBtnClip"]["Size"] = UDim2.new(0, 0, 0.6, 0);
    objects["InstanceBtnClip"]["BackgroundTransparency"] = 1;
    objects["InstanceBtnClip"]["BorderSizePixel"] = 0;
    objects["InstanceBtnClip"]["Text"] = "";
    objects["InstanceBtnClip"]["AutoButtonColor"] = false;
    objects["InstanceBtnClip"]["Active"] = true;
    objects["InstanceBtnClip"]["ZIndex"] = 2;

    objects["InstanceBtnClipARC"]["AspectRatio"] = 1;
    objects["InstanceBtnClipARC"]["Parent"] = objects["InstanceBtnClip"];
    objects["InstanceBtnClipARC"]["AspectType"] = Enum.AspectType.FitWithinMaxSize;
    objects["InstanceBtnClipARC"]["DominantAxis"] = Enum.DominantAxis.Height;

    objects["InstanceBtnClipIcon"]["Name"] = "Icon";
    objects["InstanceBtnClipIcon"]["Parent"] = objects["InstanceBtnClip"];
    objects["InstanceBtnClipIcon"]["Size"] = UDim2.new(0.55, 0, 0.55, 0);
    objects["InstanceBtnClipIcon"]["Position"] = UDim2.new(0.5, 0, 0.5, 0);
    objects["InstanceBtnClipIcon"]["AnchorPoint"] = Vector2.new(0.5, 0.5);
    objects["InstanceBtnClipIcon"]["BackgroundTransparency"] = 1;
    objects["InstanceBtnClipIcon"]["Image"] = "rbxassetid://3926305904";
    objects["InstanceBtnClipIcon"]["ImageColor3"] = Color3.new(0.7, 0.7, 0.7);
    objects["InstanceBtnClipIcon"]["ZIndex"] = 2;
    objects["InstanceBtnClipIcon"]["BorderSizePixel"] = 0;

    -- Bookmark button
    objects["InstanceBtnBM"]["Name"] = "BMBtn";
    objects["InstanceBtnBM"]["Parent"] = objects["Instance20"];
    objects["InstanceBtnBM"]["AnchorPoint"] = Vector2.new(1, 0.5);
    objects["InstanceBtnBM"]["Position"] = UDim2.new(0.765, 0, 0.5, 0);
    objects["InstanceBtnBM"]["Size"] = UDim2.new(0, 0, 0.6, 0);
    objects["InstanceBtnBM"]["BackgroundTransparency"] = 1;
    objects["InstanceBtnBM"]["BorderSizePixel"] = 0;
    objects["InstanceBtnBM"]["Text"] = "";
    objects["InstanceBtnBM"]["AutoButtonColor"] = false;
    objects["InstanceBtnBM"]["Active"] = true;
    objects["InstanceBtnBM"]["ZIndex"] = 2;

    objects["InstanceBtnBMARC"]["AspectRatio"] = 1;
    objects["InstanceBtnBMARC"]["Parent"] = objects["InstanceBtnBM"];
    objects["InstanceBtnBMARC"]["AspectType"] = Enum.AspectType.FitWithinMaxSize;
    objects["InstanceBtnBMARC"]["DominantAxis"] = Enum.DominantAxis.Height;

    objects["InstanceBtnBMIcon"]["Name"] = "Icon";
    objects["InstanceBtnBMIcon"]["Parent"] = objects["InstanceBtnBM"];
    objects["InstanceBtnBMIcon"]["Size"] = UDim2.new(0.55, 0, 0.55, 0);
    objects["InstanceBtnBMIcon"]["Position"] = UDim2.new(0.5, 0, 0.5, 0);
    objects["InstanceBtnBMIcon"]["AnchorPoint"] = Vector2.new(0.5, 0.5);
    objects["InstanceBtnBMIcon"]["BackgroundTransparency"] = 1;
    objects["InstanceBtnBMIcon"]["Image"] = "rbxassetid://7072725342";
    objects["InstanceBtnBMIcon"]["ImageColor3"] = Color3.new(0.7, 0.7, 0.7);
    objects["InstanceBtnBMIcon"]["ZIndex"] = 2;
    objects["InstanceBtnBMIcon"]["BorderSizePixel"] = 0;

    -- Theme button
    objects["InstanceBtnTheme"]["Name"] = "ThemeBtn";
    objects["InstanceBtnTheme"]["Parent"] = objects["Instance20"];
    objects["InstanceBtnTheme"]["AnchorPoint"] = Vector2.new(1, 0.5);
    objects["InstanceBtnTheme"]["Position"] = UDim2.new(0.81, 0, 0.5, 0);
    objects["InstanceBtnTheme"]["Size"] = UDim2.new(0, 0, 0.6, 0);
    objects["InstanceBtnTheme"]["BackgroundTransparency"] = 1;
    objects["InstanceBtnTheme"]["BorderSizePixel"] = 0;
    objects["InstanceBtnTheme"]["Text"] = "";
    objects["InstanceBtnTheme"]["AutoButtonColor"] = false;
    objects["InstanceBtnTheme"]["Active"] = true;
    objects["InstanceBtnTheme"]["ZIndex"] = 2;

    objects["InstanceBtnThemeARC"]["AspectRatio"] = 1;
    objects["InstanceBtnThemeARC"]["Parent"] = objects["InstanceBtnTheme"];
    objects["InstanceBtnThemeARC"]["AspectType"] = Enum.AspectType.FitWithinMaxSize;
    objects["InstanceBtnThemeARC"]["DominantAxis"] = Enum.DominantAxis.Height;

    objects["InstanceBtnThemeIcon"]["Name"] = "Icon";
    objects["InstanceBtnThemeIcon"]["Parent"] = objects["InstanceBtnTheme"];
    objects["InstanceBtnThemeIcon"]["Size"] = UDim2.new(0.55, 0, 0.55, 0);
    objects["InstanceBtnThemeIcon"]["Position"] = UDim2.new(0.5, 0, 0.5, 0);
    objects["InstanceBtnThemeIcon"]["AnchorPoint"] = Vector2.new(0.5, 0.5);
    objects["InstanceBtnThemeIcon"]["BackgroundTransparency"] = 1;
    objects["InstanceBtnThemeIcon"]["Image"] = "rbxassetid://11419704997";
    objects["InstanceBtnThemeIcon"]["ImageColor3"] = Color3.new(0.7, 0.7, 0.7);
    objects["InstanceBtnThemeIcon"]["ZIndex"] = 2;
    objects["InstanceBtnThemeIcon"]["BorderSizePixel"] = 0;

    -- =====================================================
    -- CLIPBOARD HISTORY PANEL (overlay inside Main)
    -- =====================================================
    objects["InstanceClipFrame"]["Name"] = "ClipHistory";
    objects["InstanceClipFrame"]["Parent"] = objects["Instance19"]; -- Main
    objects["InstanceClipFrame"]["AnchorPoint"] = Vector2.new(0.5, 0.5);
    objects["InstanceClipFrame"]["Position"] = UDim2.new(0.5, 0, 0.55, 0);
    objects["InstanceClipFrame"]["Size"] = UDim2.new(0.6, 0, 0.7, 0);
    objects["InstanceClipFrame"]["BackgroundColor3"] = Color3.new(0.105882, 0.105882, 0.105882);
    objects["InstanceClipFrame"]["BackgroundTransparency"] = 0.05;
    objects["InstanceClipFrame"]["BorderSizePixel"] = 0;
    objects["InstanceClipFrame"]["ZIndex"] = 20;
    objects["InstanceClipFrame"]["Visible"] = false;
    objects["InstanceClipFrame"]["ClipsDescendants"] = true;

    objects["InstanceClipCorner"]["CornerRadius"] = UDim.new(0, 8);
    objects["InstanceClipCorner"]["Parent"] = objects["InstanceClipFrame"];

    objects["InstanceClipStroke"]["Parent"] = objects["InstanceClipFrame"];
    objects["InstanceClipStroke"]["Color"] = Color3.new(0.294118, 0.294118, 0.294118);
    objects["InstanceClipStroke"]["Thickness"] = 1;
    objects["InstanceClipStroke"]["Transparency"] = 0.5;

    objects["InstanceClipTitle"]["Name"] = "Title";
    objects["InstanceClipTitle"]["Parent"] = objects["InstanceClipFrame"];
    objects["InstanceClipTitle"]["AnchorPoint"] = Vector2.new(0, 0);
    objects["InstanceClipTitle"]["Position"] = UDim2.new(0.04, 0, 0, 0);
    objects["InstanceClipTitle"]["Size"] = UDim2.new(0.8, 0, 0.12, 0);
    objects["InstanceClipTitle"]["BackgroundTransparency"] = 1;
    objects["InstanceClipTitle"]["TextColor3"] = Color3.new(1, 1, 1);
    objects["InstanceClipTitle"]["TextScaled"] = true;
    objects["InstanceClipTitle"]["TextXAlignment"] = Enum.TextXAlignment.Left;
    objects["InstanceClipTitle"]["FontFace"] = Font.new("rbxasset://fonts/families/TitilliumWeb.json", Enum.FontWeight.Bold, Enum.FontStyle.Normal, true);
    objects["InstanceClipTitle"]["Text"] = "Clipboard History";
    objects["InstanceClipTitle"]["ZIndex"] = 21;
    objects["InstanceClipTitle"]["BorderSizePixel"] = 0;

    objects["InstanceClipSep"]["Name"] = "Sep";
    objects["InstanceClipSep"]["Parent"] = objects["InstanceClipFrame"];
    objects["InstanceClipSep"]["AnchorPoint"] = Vector2.new(0.5, 0);
    objects["InstanceClipSep"]["Position"] = UDim2.new(0.5, 0, 0.12, 0);
    objects["InstanceClipSep"]["Size"] = UDim2.new(0.94, 0, 0, 1);
    objects["InstanceClipSep"]["BackgroundColor3"] = Color3.new(0.294118, 0.294118, 0.294118);
    objects["InstanceClipSep"]["BorderSizePixel"] = 0;
    objects["InstanceClipSep"]["ZIndex"] = 21;

    objects["InstanceClipClose"]["Name"] = "CloseBtn";
    objects["InstanceClipClose"]["Parent"] = objects["InstanceClipFrame"];
    objects["InstanceClipClose"]["AnchorPoint"] = Vector2.new(1, 0.5);
    objects["InstanceClipClose"]["Position"] = UDim2.new(0.98, 0, 0.06, 0);
    objects["InstanceClipClose"]["Size"] = UDim2.new(0, 0, 0.1, 0);
    objects["InstanceClipClose"]["BackgroundTransparency"] = 1;
    objects["InstanceClipClose"]["BorderSizePixel"] = 0;
    objects["InstanceClipClose"]["Text"] = "";
    objects["InstanceClipClose"]["AutoButtonColor"] = false;
    objects["InstanceClipClose"]["Active"] = true;
    objects["InstanceClipClose"]["ZIndex"] = 22;

    objects["InstanceClipCloseARC"]["AspectRatio"] = 1;
    objects["InstanceClipCloseARC"]["Parent"] = objects["InstanceClipClose"];
    objects["InstanceClipCloseARC"]["AspectType"] = Enum.AspectType.FitWithinMaxSize;
    objects["InstanceClipCloseARC"]["DominantAxis"] = Enum.DominantAxis.Height;

    objects["InstanceClipCloseIcon"]["Name"] = "Icon";
    objects["InstanceClipCloseIcon"]["Parent"] = objects["InstanceClipClose"];
    objects["InstanceClipCloseIcon"]["Size"] = UDim2.new(0.6, 0, 0.6, 0);
    objects["InstanceClipCloseIcon"]["Position"] = UDim2.new(0.5, 0, 0.5, 0);
    objects["InstanceClipCloseIcon"]["AnchorPoint"] = Vector2.new(0.5, 0.5);
    objects["InstanceClipCloseIcon"]["BackgroundTransparency"] = 1;
    objects["InstanceClipCloseIcon"]["Image"] = "rbxassetid://10152135063";
    objects["InstanceClipCloseIcon"]["ImageColor3"] = Color3.new(0.7, 0.7, 0.7);
    objects["InstanceClipCloseIcon"]["ZIndex"] = 22;
    objects["InstanceClipCloseIcon"]["BorderSizePixel"] = 0;

    objects["InstanceClipScroll"]["Name"] = "Scroll";
    objects["InstanceClipScroll"]["Parent"] = objects["InstanceClipFrame"];
    objects["InstanceClipScroll"]["Position"] = UDim2.new(0.03, 0, 0.14, 0);
    objects["InstanceClipScroll"]["Size"] = UDim2.new(0.94, 0, 0.83, 0);
    objects["InstanceClipScroll"]["BackgroundTransparency"] = 1;
    objects["InstanceClipScroll"]["BorderSizePixel"] = 0;
    objects["InstanceClipScroll"]["ScrollBarThickness"] = 3;
    objects["InstanceClipScroll"]["ScrollBarImageColor3"] = Color3.new(0.4, 0.4, 0.4);
    objects["InstanceClipScroll"]["ZIndex"] = 21;
    objects["InstanceClipScroll"]["CanvasSize"] = UDim2.new(0, 0, 0, 0);
    objects["InstanceClipScroll"]["AutomaticCanvasSize"] = Enum.AutomaticSize.Y;

    objects["InstanceClipList"]["Parent"] = objects["InstanceClipScroll"];
    objects["InstanceClipList"]["FillDirection"] = Enum.FillDirection.Vertical;
    objects["InstanceClipList"]["HorizontalAlignment"] = Enum.HorizontalAlignment.Center;
    objects["InstanceClipList"]["SortOrder"] = Enum.SortOrder.LayoutOrder;
    objects["InstanceClipList"]["Padding"] = UDim.new(0, 4);

    objects["InstanceClipEmpty"]["Name"] = "Empty";
    objects["InstanceClipEmpty"]["Parent"] = objects["InstanceClipScroll"];
    objects["InstanceClipEmpty"]["Size"] = UDim2.new(1, 0, 0, 40);
    objects["InstanceClipEmpty"]["BackgroundTransparency"] = 1;
    objects["InstanceClipEmpty"]["TextColor3"] = Color3.new(0.5, 0.5, 0.5);
    objects["InstanceClipEmpty"]["TextScaled"] = true;
    objects["InstanceClipEmpty"]["FontFace"] = Font.new("rbxasset://fonts/families/Nunito.json", Enum.FontWeight.Regular, Enum.FontStyle.Normal, false);
    objects["InstanceClipEmpty"]["Text"] = "No clipboard history yet";
    objects["InstanceClipEmpty"]["ZIndex"] = 21;
    objects["InstanceClipEmpty"]["BorderSizePixel"] = 0;

    -- =====================================================
    -- BOOKMARKS PANEL (overlay inside Main)
    -- =====================================================
    objects["InstanceBMFrame"]["Name"] = "Bookmarks";
    objects["InstanceBMFrame"]["Parent"] = objects["Instance19"];
    objects["InstanceBMFrame"]["AnchorPoint"] = Vector2.new(0.5, 0.5);
    objects["InstanceBMFrame"]["Position"] = UDim2.new(0.5, 0, 0.55, 0);
    objects["InstanceBMFrame"]["Size"] = UDim2.new(0.6, 0, 0.7, 0);
    objects["InstanceBMFrame"]["BackgroundColor3"] = Color3.new(0.105882, 0.105882, 0.105882);
    objects["InstanceBMFrame"]["BackgroundTransparency"] = 0.05;
    objects["InstanceBMFrame"]["BorderSizePixel"] = 0;
    objects["InstanceBMFrame"]["ZIndex"] = 20;
    objects["InstanceBMFrame"]["Visible"] = false;
    objects["InstanceBMFrame"]["ClipsDescendants"] = true;

    objects["InstanceBMCorner"]["CornerRadius"] = UDim.new(0, 8);
    objects["InstanceBMCorner"]["Parent"] = objects["InstanceBMFrame"];

    objects["InstanceBMStroke"]["Parent"] = objects["InstanceBMFrame"];
    objects["InstanceBMStroke"]["Color"] = Color3.new(0.294118, 0.294118, 0.294118);
    objects["InstanceBMStroke"]["Thickness"] = 1;
    objects["InstanceBMStroke"]["Transparency"] = 0.5;

    objects["InstanceBMTitle"]["Name"] = "Title";
    objects["InstanceBMTitle"]["Parent"] = objects["InstanceBMFrame"];
    objects["InstanceBMTitle"]["AnchorPoint"] = Vector2.new(0, 0);
    objects["InstanceBMTitle"]["Position"] = UDim2.new(0.04, 0, 0, 0);
    objects["InstanceBMTitle"]["Size"] = UDim2.new(0.7, 0, 0.12, 0);
    objects["InstanceBMTitle"]["BackgroundTransparency"] = 1;
    objects["InstanceBMTitle"]["TextColor3"] = Color3.new(1, 1, 1);
    objects["InstanceBMTitle"]["TextScaled"] = true;
    objects["InstanceBMTitle"]["TextXAlignment"] = Enum.TextXAlignment.Left;
    objects["InstanceBMTitle"]["FontFace"] = Font.new("rbxasset://fonts/families/TitilliumWeb.json", Enum.FontWeight.Bold, Enum.FontStyle.Normal, true);
    objects["InstanceBMTitle"]["Text"] = "Bookmarks";
    objects["InstanceBMTitle"]["ZIndex"] = 21;
    objects["InstanceBMTitle"]["BorderSizePixel"] = 0;

    objects["InstanceBMSep"]["Name"] = "Sep";
    objects["InstanceBMSep"]["Parent"] = objects["InstanceBMFrame"];
    objects["InstanceBMSep"]["AnchorPoint"] = Vector2.new(0.5, 0);
    objects["InstanceBMSep"]["Position"] = UDim2.new(0.5, 0, 0.12, 0);
    objects["InstanceBMSep"]["Size"] = UDim2.new(0.94, 0, 0, 1);
    objects["InstanceBMSep"]["BackgroundColor3"] = Color3.new(0.294118, 0.294118, 0.294118);
    objects["InstanceBMSep"]["BorderSizePixel"] = 0;
    objects["InstanceBMSep"]["ZIndex"] = 21;

    objects["InstanceBMClose"]["Name"] = "CloseBtn";
    objects["InstanceBMClose"]["Parent"] = objects["InstanceBMFrame"];
    objects["InstanceBMClose"]["AnchorPoint"] = Vector2.new(1, 0.5);
    objects["InstanceBMClose"]["Position"] = UDim2.new(0.98, 0, 0.06, 0);
    objects["InstanceBMClose"]["Size"] = UDim2.new(0, 0, 0.1, 0);
    objects["InstanceBMClose"]["BackgroundTransparency"] = 1;
    objects["InstanceBMClose"]["BorderSizePixel"] = 0;
    objects["InstanceBMClose"]["Text"] = "";
    objects["InstanceBMClose"]["AutoButtonColor"] = false;
    objects["InstanceBMClose"]["Active"] = true;
    objects["InstanceBMClose"]["ZIndex"] = 22;

    objects["InstanceBMCloseARC"]["AspectRatio"] = 1;
    objects["InstanceBMCloseARC"]["Parent"] = objects["InstanceBMClose"];
    objects["InstanceBMCloseARC"]["AspectType"] = Enum.AspectType.FitWithinMaxSize;
    objects["InstanceBMCloseARC"]["DominantAxis"] = Enum.DominantAxis.Height;

    objects["InstanceBMCloseIcon"]["Name"] = "Icon";
    objects["InstanceBMCloseIcon"]["Parent"] = objects["InstanceBMClose"];
    objects["InstanceBMCloseIcon"]["Size"] = UDim2.new(0.6, 0, 0.6, 0);
    objects["InstanceBMCloseIcon"]["Position"] = UDim2.new(0.5, 0, 0.5, 0);
    objects["InstanceBMCloseIcon"]["AnchorPoint"] = Vector2.new(0.5, 0.5);
    objects["InstanceBMCloseIcon"]["BackgroundTransparency"] = 1;
    objects["InstanceBMCloseIcon"]["Image"] = "rbxassetid://10152135063";
    objects["InstanceBMCloseIcon"]["ImageColor3"] = Color3.new(0.7, 0.7, 0.7);
    objects["InstanceBMCloseIcon"]["ZIndex"] = 22;
    objects["InstanceBMCloseIcon"]["BorderSizePixel"] = 0;

    objects["InstanceBMAddBtn"]["Name"] = "AddBtn";
    objects["InstanceBMAddBtn"]["Parent"] = objects["InstanceBMFrame"];
    objects["InstanceBMAddBtn"]["AnchorPoint"] = Vector2.new(1, 0.5);
    objects["InstanceBMAddBtn"]["Position"] = UDim2.new(0.88, 0, 0.06, 0);
    objects["InstanceBMAddBtn"]["Size"] = UDim2.new(0.22, 0, 0.1, 0);
    objects["InstanceBMAddBtn"]["BackgroundColor3"] = Color3.new(0.2, 0.2, 0.2);
    objects["InstanceBMAddBtn"]["BorderSizePixel"] = 0;
    objects["InstanceBMAddBtn"]["Text"] = "";
    objects["InstanceBMAddBtn"]["AutoButtonColor"] = false;
    objects["InstanceBMAddBtn"]["Active"] = true;
    objects["InstanceBMAddBtn"]["ZIndex"] = 22;

    objects["InstanceBMAddCorner"]["CornerRadius"] = UDim.new(0, 6);
    objects["InstanceBMAddCorner"]["Parent"] = objects["InstanceBMAddBtn"];

    objects["InstanceBMAddLabel"]["Name"] = "Label";
    objects["InstanceBMAddLabel"]["Parent"] = objects["InstanceBMAddBtn"];
    objects["InstanceBMAddLabel"]["Size"] = UDim2.new(1, 0, 1, 0);
    objects["InstanceBMAddLabel"]["BackgroundTransparency"] = 1;
    objects["InstanceBMAddLabel"]["TextColor3"] = Color3.new(0.7, 0.7, 0.7);
    objects["InstanceBMAddLabel"]["TextScaled"] = true;
    objects["InstanceBMAddLabel"]["FontFace"] = Font.new("rbxasset://fonts/families/TitilliumWeb.json", Enum.FontWeight.Bold, Enum.FontStyle.Normal, true);
    objects["InstanceBMAddLabel"]["Text"] = "+ Add current";
    objects["InstanceBMAddLabel"]["ZIndex"] = 22;
    objects["InstanceBMAddLabel"]["BorderSizePixel"] = 0;

    objects["InstanceBMScroll"]["Name"] = "Scroll";
    objects["InstanceBMScroll"]["Parent"] = objects["InstanceBMFrame"];
    objects["InstanceBMScroll"]["Position"] = UDim2.new(0.03, 0, 0.14, 0);
    objects["InstanceBMScroll"]["Size"] = UDim2.new(0.94, 0, 0.83, 0);
    objects["InstanceBMScroll"]["BackgroundTransparency"] = 1;
    objects["InstanceBMScroll"]["BorderSizePixel"] = 0;
    objects["InstanceBMScroll"]["ScrollBarThickness"] = 3;
    objects["InstanceBMScroll"]["ScrollBarImageColor3"] = Color3.new(0.4, 0.4, 0.4);
    objects["InstanceBMScroll"]["ZIndex"] = 21;
    objects["InstanceBMScroll"]["CanvasSize"] = UDim2.new(0, 0, 0, 0);
    objects["InstanceBMScroll"]["AutomaticCanvasSize"] = Enum.AutomaticSize.Y;

    objects["InstanceBMList"]["Parent"] = objects["InstanceBMScroll"];
    objects["InstanceBMList"]["FillDirection"] = Enum.FillDirection.Vertical;
    objects["InstanceBMList"]["HorizontalAlignment"] = Enum.HorizontalAlignment.Center;
    objects["InstanceBMList"]["SortOrder"] = Enum.SortOrder.LayoutOrder;
    objects["InstanceBMList"]["Padding"] = UDim.new(0, 4);

    objects["InstanceBMEmpty"]["Name"] = "Empty";
    objects["InstanceBMEmpty"]["Parent"] = objects["InstanceBMScroll"];
    objects["InstanceBMEmpty"]["Size"] = UDim2.new(1, 0, 0, 40);
    objects["InstanceBMEmpty"]["BackgroundTransparency"] = 1;
    objects["InstanceBMEmpty"]["TextColor3"] = Color3.new(0.5, 0.5, 0.5);
    objects["InstanceBMEmpty"]["TextScaled"] = true;
    objects["InstanceBMEmpty"]["FontFace"] = Font.new("rbxasset://fonts/families/Nunito.json", Enum.FontWeight.Regular, Enum.FontStyle.Normal, false);
    objects["InstanceBMEmpty"]["Text"] = "No bookmarks yet";
    objects["InstanceBMEmpty"]["ZIndex"] = 21;
    objects["InstanceBMEmpty"]["BorderSizePixel"] = 0;
...
return {
    { "1.10", "<b>Modified By JABA</b> — Added: hide button in topbar, draggable open button (RShift hotkey), toast notifications, activity badges on RSpy/ESpy/HTTPSpy, window resize handle, clipboard history panel, bookmarks panel, theme switcher (Default / Midnight / Slate)." },
...
return function(shared, page)
    ...
    local function addLog(version, text)
        ...
        log.Size = UDim2.new(1, 0, 0, log.TextBounds.Y)
        local versionNum = tonumber(version) or 0
        log.LayoutOrder = maxBit32 - math.floor(versionNum * 100)
...
-- =====================================================
-- HIDE BUTTON (в топбаре, рядом с Close)
-- =====================================================
local hideBtn = objects["InstanceHideBtn"]
local openBtn = objects["InstanceOpenBtn"]
...
cons[#cons+1] = hideBtn.MouseButton1Click:Connect(hideGui)

-- =====================================================
-- HOTKEY: RightShift = скрыть/показать
-- =====================================================
cons[#cons+1] = game:GetService("UserInputService").InputBegan:Connect(function(input, buzy)
...
-- =====================================================
-- FLOATING OPEN BUTTON: перетаскивание
-- =====================================================
local dragging = false
local dragStartPos
local btnStartPos
...
game:GetService("UserInputService").InputChanged:Connect(function(input)
    if dragging and (input.UserInputType == Enum.UserInputType.MouseMovement or input.UserInputType == Enum.UserInputType.Touch) then
        ...
        local newX = math.clamp(btnStartPos.X.Scale + delta.X / vp.X, 0.02, 0.98)
        local newY = math.clamp(btnStartPos.Y.Scale + delta.Y / vp.Y, 0.02, 0.98)
        openBtn.Position = UDim2.new(newX, 0, newY, 0)
    end
end)
...
-- =====================================================
local toastHolder = objects["InstanceToastHolder"]
local toastTemplate = objects["InstanceToast"]
local tweenS = game:GetService("TweenService")

local function showToast(text, color, duration)
    color = color or Color3.new(0.5, 0.8, 0.5)
    duration = duration or 2.5

    local toast = toastTemplate:Clone()
    toast.Bar.BackgroundColor3 = color
    toast.Label.Text = text
    toast.Visible = true
    toast.Size = UDim2.new(1, 0, 0, 0)
    toast.BackgroundTransparency = 1
    toast.Label.TextTransparency = 1
    toast.Parent = toastHolder

    tweenS:Create(toast, TweenInfo.new(0.25, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {
        Size = UDim2.new(1, 0, 0, 44),
        BackgroundTransparency = 0.1
    }):Play()
    tweenS:Create(toast.Label, TweenInfo.new(0.25), {TextTransparency = 0}):Play()

    task.delay(duration, function()
        tweenS:Create(toast, TweenInfo.new(0.3), {BackgroundTransparency = 1, Position = toast.Position + UDim2.new(0.15, 0, 0, 0)}):Play()
        tweenS:Create(toast.Label, TweenInfo.new(0.3), {TextTransparency = 1}):Play()
        task.wait(0.35)
        toast:Destroy()
    end)
end

-- Экспортируем toast в shared для доступа из других модулей
shared.ShowToast = showToast

-- =====================================================
-- BADGES: счётчики событий RSpy / ESpy / HTTPSpy
-- =====================================================
local badgeRSpy = objects["InstanceBadgeRSpy"]
local badgeESpy = objects["InstanceBadgeESpy"]
local badgeHTTP = objects["InstanceBadgeHTTP"]
local countRSpy, countESpy, countHTTP = 0, 0, 0
...
local function resetBadges()
    countRSpy, countESpy, countHTTP = 0, 0, 0
    updateBadge(badgeRSpy, 0)
    updateBadge(badgeESpy, 0)
    updateBadge(badgeHTTP, 0)
end

-- Перехватываем добавление логов через hook на ScrollingFrame
local rspyLogs = script.Parent.Main.Contents.Pages.RSpy.From.Logs
local espyLogs = script.Parent.Main.Contents.Pages.ESpy.Logs
local httpLogs = script.Parent.Main.Contents.Pages.HTTPSpy.Contents.Logs

rspyLogs.ChildAdded:Connect(function(child)
    if child:IsA("TextButton") then
        countRSpy += 1
        updateBadge(badgeRSpy, countRSpy)
    end
end)

espyLogs.ChildAdded:Connect(function(child)
    if child:IsA("TextButton") then
        countESpy += 1
        updateBadge(badgeESpy, countESpy)
    end
end)

httpLogs.ChildAdded:Connect(function(child)
    if child:IsA("TextButton") then
        countHTTP += 1
        updateBadge(badgeHTTP, countHTTP)
    end
end)

-- Сброс счётчика при клике на вкладку
objects["Instance54"].MouseButton1Click:Connect(function() countRSpy = 0; updateBadge(badgeRSpy, 0) end) -- RSpy
objects["Instance69"].MouseButton1Click:Connect(function() countESpy = 0; updateBadge(badgeESpy, 0) end) -- ESpy
objects["Instance64"].MouseButton1Click:Connect(function() countHTTP = 0; updateBadge(badgeHTTP, 0) end) -- HTTPSpy

-- =====================================================
-- RESIZE HANDLE
-- =====================================================
local resizeHandle = objects["InstanceResizeHandle"]
...
game:GetService("UserInputService").InputChanged:Connect(function(input)
    if resizing and (input.UserInputType == Enum.UserInputType.MouseMovement or input.UserInputType == Enum.UserInputType.Touch) then
        ...
        local vp = workspace.CurrentCamera.ViewportSize
        local newW = math.clamp((resizeStartSize.X + delta.X) / vp.X, 0.2, 0.85)
        local newH = math.clamp((resizeStartSize.Y + delta.Y) / vp.Y, 0.2, 0.85)
        oldSize = UDim2.fromScale(newW, newH)
        window.Size = oldSize
    end
end)
...
-- CLIPBOARD HISTORY
-- =====================================================
local clipFrame = objects["InstanceClipFrame"]
local clipScroll = objects["InstanceClipScroll"]
local clipEmpty = objects["InstanceClipEmpty"]
local clipBtn = objects["InstanceBtnClip"]
local clipHistory = {}
local MAX_CLIP = 20

local function refreshClipUI()
    for _, c in clipScroll:GetChildren() do
        if c:IsA("TextButton") then c:Destroy() end
    end
    clipEmpty.Visible = #clipHistory == 0
    for i = #clipHistory, 1, -1 do
        local entry = clipHistory[i]
        ...
        btn.FontFace = Font.new("rbxasset://fonts/families/Nunito.json", Enum.FontWeight.Regular, Enum.FontStyle.Normal, false)
        btn.Text = "  " .. (entry:sub(1, 60)) .. (#entry > 60 and "..." or "")
        btn.AutoButtonColor = false
        btn.ZIndex = 22
        btn.LayoutOrder = i
        local c2 = Instance.new("UICorner"); c2.CornerRadius = UDim.new(0, 6); c2.Parent = btn
        local s2 = Instance.new("UIStroke"); s2.Color = Color3.new(0.294118, 0.294118, 0.294118); s2.Transparency = 0.6; s2.Thickness = 1; s2.Parent = btn
        btn.MouseButton1Click:Connect(function()
            if setclipboard then setclipboard(entry) end
            showToast("Copied!", Color3.new(0.5, 0.8, 0.5))
        end)
        btn.MouseEnter:Connect(function()
            tweenS:Create(btn, TweenInfo.new(0.15), {BackgroundTransparency = 0.1}):Play()
        end)
        btn.MouseLeave:Connect(function()
            tweenS:Create(btn, TweenInfo.new(0.15), {BackgroundTransparency = 0.3}):Play()
        end)
        btn.Parent = clipScroll
    end
end

local function addToClipboard(text)
    if text == "" then return end
    -- не дублируем последний
    if #clipHistory > 0 and clipHistory[#clipHistory] == text then return end
    table.insert(clipHistory, text)
    if #clipHistory > MAX_CLIP then table.remove(clipHistory, 1) end
    refreshClipUI()
end

-- Хук: перехватываем setclipboard
if getfenv().setclipboard then
    local orig = getfenv().setclipboard
    getfenv().setclipboard = function(text)
        orig(text)
        addToClipboard(text)
        showToast("Copied to clipboard", Color3.new(0.5, 0.8, 0.5))
    end
end

clipBtn.MouseButton1Click:Connect(function()
    clipFrame.Visible = not clipFrame.Visible
    if clipFrame.Visible then
        objects["InstanceBMFrame"].Visible = false
        refreshClipUI()
    end
end)

objects["InstanceClipClose"].MouseButton1Click:Connect(function()
...
-- BOOKMARKS
-- =====================================================
local bmFrame = objects["InstanceBMFrame"]
local bmScroll = objects["InstanceBMScroll"]
local bmEmpty = objects["InstanceBMEmpty"]
local bmBtn = objects["InstanceBtnBM"]
local bmAddBtn = objects["InstanceBMAddBtn"]
local bookmarks = {}

local function refreshBMUI()
    for _, c in bmScroll:GetChildren() do
        if c:IsA("Frame") then c:Destroy() end
    end
    bmEmpty.Visible = #bookmarks == 0
    for i, bm in ipairs(bookmarks) do
        local row = Instance.new("Frame")
        row.Size = UDim2.new(1, 0, 0, 38)
        row.BackgroundColor3 = Color3.new(0.15, 0.15, 0.15)
        row.BackgroundTransparency = 0.3
        row.BorderSizePixel = 0
        row.ZIndex = 22
        row.LayoutOrder = i
        local rc = Instance.new("UICorner"); rc.CornerRadius = UDim.new(0, 6); rc.Parent = row
        local rs = Instance.new("UIStroke"); rs.Color = Color3.new(0.294118, 0.294118, 0.294118); rs.Transparency = 0.6; rs.Thickness = 1; rs.Parent = row
        ...
        nameLabel.FontFace = Font.new("rbxasset://fonts/families/Nunito.json", Enum.FontWeight.Regular, Enum.FontStyle.Normal, false)
        ...
        delBtn.Size = UDim2.new(0.18, 0, 0.6, 0)
        delBtn.AnchorPoint = Vector2.new(1, 0.5)
        delBtn.Position = UDim2.new(0.99, 0, 0.5, 0)
        delBtn.BackgroundColor3 = Color3.new(0.5, 0.15, 0.15)
        delBtn.BackgroundTransparency = 0.4
        delBtn.BorderSizePixel = 0
        delBtn.TextColor3 = Color3.new(1, 0.5, 0.5)
        delBtn.TextScaled = true
        delBtn.FontFace = Font.new("rbxasset://fonts/families/TitilliumWeb.json", Enum.FontWeight.Bold, Enum.FontStyle.Normal, true)
        delBtn.Text = "✕"
        ...
        delBtn.MouseButton1Click:Connect(function()
            ...
            refreshBMUI()
            showToast("Bookmark removed", Color3.new(0.8, 0.4, 0.4))
        end)
        delBtn.Parent = row
        row.Parent = bmScroll
    end
...
bmBtn.MouseButton1Click:Connect(function()
    bmFrame.Visible = not bmFrame.Visible
    if bmFrame.Visible then
        clipFrame.Visible = false
        refreshBMUI()
    end
end)

objects["InstanceBMClose"].MouseButton1Click:Connect(function()
    bmFrame.Visible = false
end)

bmAddBtn.MouseButton1Click:Connect(function()
    -- Добавляем текущую активную страницу как закладку
    local pageName = "Unknown"
    for _, btn in {objects["Instance59"], objects["Instance54"], objects["Instance69"], objects["Instance64"], objects["Instance49"], objects["Instance44"], objects["Instance39"]} do
    ...
    local ts = os.date and os.date("%H:%M") or "now"
    local bmName = pageName .. " (" .. ts .. ")"
    table.insert(bookmarks, {name = bmName, page = pageName})
    refreshBMUI()
    showToast("Bookmark added: " .. pageName, Color3.new(0.5, 0.8, 0.5))
end)

-- =====================================================
-- THEME TOGGLE (Dark / Darker / Accent)
-- =====================================================
local themeBtn = objects["InstanceBtnTheme"]
local themes = {
    {
        name = "Default",
        main = Color3.new(0.105882, 0.105882, 0.105882),
        sep  = Color3.new(0.294118, 0.294118, 0.294118),
        accent = Color3.new(1, 0.666667, 0),
    },
    {
        name = "Midnight",
        main = Color3.new(0.06, 0.06, 0.1),
        sep  = Color3.new(0.2, 0.2, 0.35),
        accent = Color3.new(0.4, 0.6, 1),
    },
    {
        name = "Slate",
        main = Color3.new(0.08, 0.08, 0.08),
        sep  = Color3.new(0.22, 0.22, 0.22),
        accent = Color3.new(0.6, 0.9, 0.6),
    },
}
local themeIndex = 1

local function applyTheme(t)
    tweenS:Create(script.Parent.Main, TweenInfo.new(0.4), {BackgroundColor3 = t.main}):Play()
    tweenS:Create(script.Parent.Main.TopbarZone.Separator, TweenInfo.new(0.4), {BackgroundColor3 = t.sep}):Play()
    tweenS:Create(script.Parent.Main.Contents.Buttons.Separator, TweenInfo.new(0.4), {BackgroundColor3 = t.sep}):Play()
    -- badge accent
    tweenS:Create(badgeRSpy, TweenInfo.new(0.4), {BackgroundColor3 = t.accent}):Play()
    showToast("Theme: " .. t.name, t.accent)
end
...
task.spawn(function()
    ...
    task.wait(2)
    showToast("Modified By JABA  v1.10  •  RShift to hide", Color3.new(0.5, 0.7, 1), 3.5)
end)
    end);
end;
